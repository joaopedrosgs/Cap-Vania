...
int main() {
  ...
  ------------------------------------------------------------ float
  a,b,c,d,e,f, distancia; printf("digite os três digitos do primeiro ponto,
  seguindo a ordem X,Y e Z"); scanf("%f %f %f",&a, &b,&c);
  ...
  */
  ...
  //CASAL DIFRENÇA ------------------------------------------------------------
      ...
      if(idade1>idade2)
      {
          ...
          printf("a diferenca de idades em porcentagem e: %i%% ",
  (int)(100*idade1/idade2)-100);
